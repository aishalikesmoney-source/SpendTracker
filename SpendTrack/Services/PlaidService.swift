...
enum PlaidError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .serverUnreachable:
            let url = UserDefaults.standard.string(forKey: Constants.UserDefaultsKeys.customServerURL) ?? Constants.serverBaseURL
            return "Cannot reach the SpendTrack server. Make sure it's running at \(url)"
